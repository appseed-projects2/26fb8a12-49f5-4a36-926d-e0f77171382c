...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-14 17:41`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/26fb8a12-49f5-4a36-926d-e0f77171382c.git
$ cd 26fb8a12-49f5-4a36-926d-e0f77171382c
```
